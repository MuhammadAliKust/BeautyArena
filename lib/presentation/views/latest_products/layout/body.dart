...
class LatestProductsViewBody extends StatefulWidget {
  @override
  State<LatestProductsViewBody> createState() => _LatestProductsViewBodyState();
}

class _LatestProductsViewBodyState extends State<LatestProductsViewBody> {
  ...
  Future<ProductModel> getApiCall(bool isRefresh) async {
    ...
    ProductModel model = await ProductServices().getRecentProducts(
